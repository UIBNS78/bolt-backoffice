...
import { DeliveryManForm } from '../../components/forms/delivery-man-form/delivery-man-form';
...
@Component({
  ...
  templateUrl: './delivery-man-list.html',
  styleUrl: './delivery-man-list.css',
})
export class DeliveryManList implements OnInit, OnDestroy {
